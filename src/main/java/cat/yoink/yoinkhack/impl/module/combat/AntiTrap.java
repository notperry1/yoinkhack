...
public class AntiTrap extends Module
{
	...
	private final Setting mode = new Setting("Mode", this, "Single", new ArrayList<>(Arrays.asList("Single", "Double")));
	private final ArrayList<BlockPos> renderBlocks = new ArrayList<>();
	private int ticksOn;


	public AntiTrap(String name, Category category, String description)
	{
