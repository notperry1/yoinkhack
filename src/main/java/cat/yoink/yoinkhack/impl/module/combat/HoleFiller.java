...
public class HoleFiller extends Module
{
	...
	private final Setting blockMode = new Setting("Block", this, "Obsidian", new ArrayList<>(Arrays.asList("Obsidian", "Web")));
	private final Setting self = new Setting("Self", this, false);

	private int oldHand;

	public HoleFiller(String name, Category category, String description)
	{
